...
---------------------------------------------------------------------------------------------
## ToDo (2024)
* Front : JavaScirpt / Node.js / React 강의 > TypeScript > Next.JS > 프론트 커리큘럼
* Backend : RestFul Web SErvices 개발 > Spring Cloud로 개발하는 마이크로서비스 애플리케이션 (MSA)
* Devops : Jenkins를 이용한 CI?CD 파이프라인 구축 > 클라우드 커리큘럼
* Cloud : AWS > 강의
* DB : Linux > 수강중 > MySQL > 친절한 SQL 튜닝 > 최종 SQLP
* 온라인스토어 
---------------------------------------------------------------------------------------------
## ToDo (2024.10)
---------------------------------------------------------------------------------------------
